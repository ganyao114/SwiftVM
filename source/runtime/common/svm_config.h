...
#define SVM_CONFIG_FIELDS(X) \
    ...
    X(bool, operand_copy_kill, "SVM_OPERAND_COPY_KILL", NonZero, false, "A64 Mul 已物化寄存器 RHS 的单用 emitter 临时 copy 抑制；非 0 开，缺省 OFF；原 translator_alu.cpp:EmitMul") \
