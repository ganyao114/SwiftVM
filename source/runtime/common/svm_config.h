...
#define SVM_CONFIG_FIELDS(X) \
    ...
    X(bool, xmm_resident, "SVM_XMM_RESIDENT", NonZero, false, "XMM0-7 固定驻留 v16-v23；非 0 开，缺省 OFF；跨 unit ABI，原 translator/x86/translator.cpp") \
    ...
    X(bool, flags_fcmp_compact, "SVM_FLAGS_FCMP_COMPACT", NonZero, false, "FCMP compact；非 0 开，缺省 OFF；原 decoder.cc:265") \
