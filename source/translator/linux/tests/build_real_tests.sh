...
if [ "$SUFFIX" = x86_64 ]; then
    gcc -nostdlib -static -Wl,--build-id=none \
        -o basic_coverage_smoke_x86_64 basic_coverage_smoke_x86_64.S
    gcc -nostdlib -static -Wl,--build-id=none \
        -o random_smoke_x86_64 random_smoke_x86_64.S
    gcc -nostdlib -static -Wl,--build-id=none \
        -o rdtsc_monotonic_x86_64 rdtsc_monotonic_x86_64.S
    gcc -nostdlib -static -Wl,--build-id=none \
    ...
    gcc -nostdlib -static -Wl,--build-id=none \
        -o clone_cmpxchg16b_x86_64 clone_cmpxchg16b_x86_64.S
    gcc -nostdlib -static -Wl,--build-id=none \
        -o cmpxchg16b_unaligned_fault_x86_64 cmpxchg16b_unaligned_fault_x86_64.S
    gcc -nostdlib -static -Wl,--build-id=none \
...
if [ "$SUFFIX" = x86_64 ]; then
    for binary in \
        basic_coverage_smoke_x86_64 \
        random_smoke_x86_64 \
        rdtsc_monotonic_x86_64 \
        vec_float_nan_pressure_x86_64 \
        x87_midtier_x86_64 \
        x87_topvirt_stress_x86_64 \
        ...
        cmpxchg16b_unaligned_fault_x86_64 \
