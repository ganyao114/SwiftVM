#!/usr/bin/env python3
"""Build a minimal static x86_64 Linux ELF executable (loop_x86_64).

Assembles loop_x86_64.S with clang, extracts the raw .text bytes with
...
SRC = os.path.join(HERE, "loop_x86_64.S")
OBJ = os.path.join(HERE, "loop_x86_64.o")
BIN = os.path.join(HERE, "loop_x86_64.bin")
OUT = os.path.join(HERE, "loop_x86_64")
