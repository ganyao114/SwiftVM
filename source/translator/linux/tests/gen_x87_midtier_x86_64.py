#!/usr/bin/env python3
"""Wrap x87_midtier_x86_64.S in a minimal writable static Linux ELF."""
...
# PF_R | PF_W | PF_X: the raw self-test keeps its scratch outputs in .text.
program = struct.pack(
    "<IIQQQQQQ", 1, 7, 0, vaddr, vaddr, size, size, 0x1000
)
