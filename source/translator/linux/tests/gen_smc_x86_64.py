#!/usr/bin/env python3
"""Build a minimal static x86_64 Linux ELF executable (smc_x86_64).

Assembles smc_x86_64.S with clang, extracts the raw .text bytes with
llvm-objcopy, then wraps them in a hand-written ET_EXEC ELF (one PT_LOAD
segment at 0x400000). Same wrapping as gen_bad_pointer_x86_64.py.
"""
...
SRC = os.path.join(HERE, "smc_x86_64.S")
OBJ = os.path.join(HERE, "smc_x86_64.o")
BIN = os.path.join(HERE, "smc_x86_64.bin")
OUT = os.path.join(HERE, "smc_x86_64")
